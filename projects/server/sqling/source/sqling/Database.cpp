...
namespace sqling {
    ...
    void Database::create_table(const vineyard::Trellis &trellis, Connection &connection) {
      string sql = "CREATE TABLE IF NOT EXISTS " + trellis.get_name() + " (\n";
//                   + "id INTEGER PRIMARY KEY,\n";
    ...
    void Database::async(sqling::Task task) {

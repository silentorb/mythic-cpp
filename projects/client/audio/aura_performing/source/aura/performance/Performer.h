...
namespace aura {
  ...
  namespace performing {
    ...
    public:
        Performer(engineering::Engineer &engineer) : engineer(engineer) {}
    ...
    MYTHIC_EXPORT void perform_chord_structure(Conductor &conductor, sequencing::Chord_Structure &chord_structure, float start,
                                               float end);
  }
}
...
namespace aura {
  namespace composing {
    ...
    class Clip : no_copy {
        ...
        Sequencer_Factory_Function<Event_Type> sequencer;
        int group_id = -1;

    public:
        Clip(performing::Instrument<Sound_Type, Event_Type> &instrument, const Sequencer_Factory_Function<Event_Type> &sequencer) :
        ...
        Sequencer_Factory_Function<Event_Type> &get_sequencer() {
          return sequencer;
        }

...
namespace aura {
  namespace sequencing {
    ...
    const Key cycle_through_keys(const Key keys[], int count, const Key key, int steps) {
      int key_index = find_index(keys, count, key) + steps;

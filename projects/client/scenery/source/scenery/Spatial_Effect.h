...
namespace scenery {
  ...
  public:
      ...
      void activate(mat4 &transform, bool has_opacity = false, float opacity = 1);
      void activate(mat4 &transform, mat4 &normal_transform, bool has_opacity = false, float opacity = 1 );

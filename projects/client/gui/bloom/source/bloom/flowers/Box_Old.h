...
namespace bloom {
  ...
  namespace flowers {
    ...
    class BLOOM_EXPORT Box_Old : public Parent_Implementation {
    ...
    public:
    Box_Old(Parent *parent = nullptr) : Parent_Implementation(parent) { }
...
template<typename Axis>
float resolve_measurement_old(const Measurement &measurement, const glm::vec2 &parent_dimensions) {

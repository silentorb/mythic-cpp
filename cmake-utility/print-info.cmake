...
function(print_info mode)
  ...
  MESSAGE(${mode} "CMAKE_CURRENT_SOURCE_DIR: " ${CMAKE_CURRENT_SOURCE_DIR})
  ...
  MESSAGE(${mode} "PROJECT_SOURCE_DIR: " ${PROJECT_SOURCE_DIR})
  ...
  MESSAGE(${mode} "CMAKE_CURRENT_LIST_FILE: " ${CMAKE_CURRENT_LIST_FILE})
